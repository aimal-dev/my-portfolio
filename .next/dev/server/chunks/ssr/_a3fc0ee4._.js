...
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://aavfqdbxrfhzqkkzwqux.supabase.co");
const supabaseAnonKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFhdmZxZGJ4cmZoenFra3p3cXV4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njg1NzIxODcsImV4cCI6MjA4NDE0ODE4N30.SnVdv_cDIjQPfnR0PwjLSP5ufcYslueJqDGRgTMFbjY");
...
async function getDB() {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('settings').select('content').eq('id', 'main_config').single();
        if (error || !data) {
            console.warn("Falling back to empty DB structure:", error?.message);
            return {
                projects: [],
                messages: [],
                profile: {}
...
async function saveDB(data) {
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('settings').upsert({
        id: 'main_config',
        content: data
    }, {
        onConflict: 'id'
...
async function uploadFile(file, folder) {
    ...
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].storage.from(BUCKET_NAME).upload(fileName, buffer, {
    ...
    const { data: { publicUrl } } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].storage.from(BUCKET_NAME).getPublicUrl(fileName);
    return publicUrl;
}
...
async function addProject(formData) {
    ...
    const uploadedUrl = await uploadFile(imageFile, 'projects');
...
async function addCertificate(formData) {
    ...
    let imagePath = "";
    const imageFile = formData.get('image');
    const uploadedUrl = await uploadFile(imageFile, 'certificates');
    if (uploadedUrl) imagePath = uploadedUrl;
    const newCert = {
        id: Date.now(),
        name: formData.get('name'),
...
async function updateAbout(formData) {
    ...
    const imageFile = formData.get('image');
    const uploadedUrl = await uploadFile(imageFile, 'about');
    if (uploadedUrl) imagePath = uploadedUrl;
    db.about = {
...
async function addExperience(formData) {
    ...
    const uploadedUrl = await uploadFile(iconFile, 'experience');
    if (uploadedUrl) iconPath = uploadedUrl;
    const newExp = {
        id: Date.now(),
...
"[project]/.next-internal/server/app/(site)/projects/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/lib/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/(site)/projects/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/lib/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$site$292f$projects$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/(site)/projects/page/actions.js { ACTIONS_MODULE0 => "[project]/src/lib/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/actions.ts [app-rsc] (ecmascript)");
}),
];

//# sourceMappingURL=_a3fc0ee4._.js.map