...
import { Experience, Education, AboutData, Certificate } from "@/lib/actions";
...
export default function AboutClient({ experience, education, certificates, aboutData }: AboutClientProps) {
    ...
    return (
        <div className={styles.container} ref={containerRef}>
            <div className={styles.mobileTabs}>
                <div className={clsx(styles.mobileTab, activeSection === 'bio' && styles.activeTab)} onClick={() => setActiveSection('bio')}>_bio</div>
                <div className={clsx(styles.mobileTab, activeSection === 'skills' && styles.activeTab)} onClick={() => setActiveSection('skills')}>_skills</div>
                <div className={clsx(styles.mobileTab, activeSection === 'education' && styles.activeTab)} onClick={() => setActiveSection('education')}>_edu</div>
                <div className={clsx(styles.mobileTab, activeSection === 'experience' && styles.activeTab)} onClick={() => setActiveSection('experience')}>_exp</div>
                <div className={clsx(styles.mobileTab, activeSection === 'certificates' && styles.activeTab)} onClick={() => setActiveSection('certificates')}>_cert</div>
            </div>
                   ...
                   {activeSection === 'bio' || activeSection === 'skills' ? (
                    ...
                    <div className={styles.codeSnippet}>
                        <code>
                                        ...
                                        &nbsp;&nbsp;<span className="blue">name</span>: <span className="orange">&quot;Aimal Dev&quot;</span>,<br/>
